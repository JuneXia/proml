...
class GeneratorUNet(nn.Module):
    ...
    def forward(self, inputa):
        ...
        self.grid_id = gen_grid((3, 3), batch_size=B)
        ...
        sparse_grid = self.grid_id + x

        dense_grid = F.interpolate(sparse_grid, size=(H, W), scale_factor=None, mode='bilinear', align_corners=True)
        dense_grid = dense_grid.permute((0, 2, 3, 1))
        fakeb = F.grid_sample(inputa, dense_grid, mode='bilinear', padding_mode='zeros')
